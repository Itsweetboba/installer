...
# ╔════════════════════════════════════════════════════════════════════╗
# ║ 🛡️  PaiiTheStory PROTECTOR SYSTEM v1.0                            ║
...
echo -e "${CYAN}${BOLD}"
echo "╔══════════════════════════════════════════════════════╗"
echo "║         PaiiTheStory Protect + Panel Builder         ║"
...
BACKUP_DIR="backup_paii_protect"
...
if [[ "$MODE" == "1" ]]; then
    ...
    for name in "${!CONTROLLERS[@]}"; do
        ...
        in_func == 1 && /^\s*{/ {
            ...
            print "            abort(403, \"PaiiTheStory Protect - Akses ditolak\");";
            print "        }";
            in_func = 0; next;
        }
        { print; }
